...
export default function SubmitDonationsRequestPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Submit Donations Request</h1>
        <p className="text-gray-600 dark:text-gray-400">Submit and manage donation requests from your organization for review and matching.</p>
      </div>
