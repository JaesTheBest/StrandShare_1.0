...
export default function ReferPatientsDonorsPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Refer Patients and Donors</h1>
        <p className="text-gray-600 dark:text-gray-400">Create and track referrals for patients in need and donors willing to contribute.</p>
      </div>
