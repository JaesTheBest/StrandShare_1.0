...
export default function GenerateCertificatePage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Generate Certificate</h1>
        <p className="text-gray-600 dark:text-gray-400">Generate donation participation and acknowledgment certificates for donors and partner records.</p>
      </div>
