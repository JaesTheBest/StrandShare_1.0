...
export default function GenerateReportPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Generate Report</h1>
        <p className="text-gray-600 dark:text-gray-400">Build summary reports for program outcomes, donor activity, and referral performance.</p>
      </div>
