...
export default function CoordinateDonationProgramsPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Coordinate Donation Programs</h1>
        <p className="text-gray-600 dark:text-gray-400">Coordinate campaigns, outreach schedules, and partner activities for donation programs.</p>
      </div>
