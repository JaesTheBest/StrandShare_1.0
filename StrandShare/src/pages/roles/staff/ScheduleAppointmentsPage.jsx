...
export default function ScheduleAppointmentsPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Schedule Appointments</h1>
        <p className="text-gray-600 dark:text-gray-400">Create and update appointment schedules for donors, recipients, and related consultations.</p>
      </div>
