...
export default function ViewDonorInformationsPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">View Donor Informations</h1>
        <p className="text-gray-600 dark:text-gray-400">Review donor profiles, contact data, and donation history for ongoing case handling.</p>
      </div>
