...
export default function UpdateWigRequestStatusPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Update Wig Request Status</h1>
        <p className="text-gray-600 dark:text-gray-400">Track and update each wig request from intake through final fulfillment and release.</p>
      </div>
