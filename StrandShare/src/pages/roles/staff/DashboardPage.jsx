  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">Staff quick access overview. Surface donor information, donation status, wig request updates, and appointments immediately.</p>
      </div>
