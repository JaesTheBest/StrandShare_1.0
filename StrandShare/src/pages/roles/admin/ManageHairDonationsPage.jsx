...
export default function ManageHairDonationsPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Manage Hair Donations</h1>
        <p className="text-gray-600 dark:text-gray-400">Review incoming hair donations, validate donation details, and organize approved donation records.</p>
      </div>
