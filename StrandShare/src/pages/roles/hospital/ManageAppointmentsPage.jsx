...
export default function ManageAppointmentsPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Manage Appointments</h1>
        <p className="text-gray-600 dark:text-gray-400">Monitor, approve, and adjust donor and recipient appointments in one consolidated scheduling workspace.</p>
      </div>
